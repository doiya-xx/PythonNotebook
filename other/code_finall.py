...
from three_example_strings import *
...
# print(entropy(melville,dickens,alphabet='abcdefghijklmnopqrstuvwxyz'))
# print(entropy(darwin,dickens,alphabet='abcdefghijklmnopqrstuvwxyz'))
# print(entropy(dickens,melville,alphabet='abcdefghijklmnopqrstuvwxyz'))
# print(entropy(darwin,melville,alphabet='abcdefghijklmnopqrstuvwxyz'))
# print(entropy(dickens,darwin,alphabet='abcdefghijklmnopqrstuvwxyz'))
# print(entropy(melville,darwin,alphabet='abcdefghijklmnopqrstuvwxyz'))
...
def NLBVP(p, guess, iterations):
    n = len(guess)
    if p == 3:
        S = np.array([float(s * n ** 2) for s in stencil(1, 1)[2]])
        DD = np.zeros((n, n))
        for i in range(1, n):
            DD[i, i - 1:i + 2] = S
